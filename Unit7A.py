...
@bot.message_handler(func=lambda message: message.text == '📝 Unit 7A Test' or message.text == '/Unit7A_Test')
...
def check_answer5(inner_message, score):
    ...
    bot.send_message(inner_message.chat.id,
                     text="Next:/Unit7B\nOr :/Unit7A_Test to "
                          "try again")
    if answer == '/Unit7B':
        bot.register_next_step_handler(inner_message, Unit7B)
